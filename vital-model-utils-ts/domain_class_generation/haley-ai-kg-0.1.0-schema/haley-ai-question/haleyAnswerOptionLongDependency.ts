...
/**
 * VitalSigns class: http://vital.ai/ontology/haley-ai-question#HaleyAnswerOptionLongDependency
 */
export class HaleyAnswerOptionLongDependency extends VITAL_Node {
  ...
  /**
   * Get property definitions for HaleyAnswerOptionLongDependency
   */
