...
/**
 * VitalSigns class: http://vital.ai/ontology/haley-ai-question#HaleyAnswerLongDependency
 */
export class HaleyAnswerLongDependency extends VITAL_Node {
  ...
  /**
   * Get property definitions for HaleyAnswerLongDependency
   */
