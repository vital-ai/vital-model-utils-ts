...
/**
 * VitalSigns class: http://vital.ai/ontology/haley-ai-question#HaleyAnswerGroupDependency
 */
export class HaleyAnswerGroupDependency extends VITAL_Node {
  ...
  /**
   * Get property definitions for HaleyAnswerGroupDependency
   */
