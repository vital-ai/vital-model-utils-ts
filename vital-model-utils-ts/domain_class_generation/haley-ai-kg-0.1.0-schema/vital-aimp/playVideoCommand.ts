...
/**
 * VitalSigns class: http://vital.ai/ontology/vital-aimp#PlayVideoCommand
 */
export class PlayVideoCommand extends UserInterfaceCommandMessage {
  ...
  /**
   * Get property definitions for PlayVideoCommand
   */
