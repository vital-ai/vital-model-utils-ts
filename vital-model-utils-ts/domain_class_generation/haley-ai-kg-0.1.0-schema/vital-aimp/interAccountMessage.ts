...
/**
 * VitalSigns class: http://vital.ai/ontology/vital-aimp#InterAccountMessage
 */
export class InterAccountMessage extends AIMPMessage {
  ...
  /**
   * Get property definitions for InterAccountMessage
   */
