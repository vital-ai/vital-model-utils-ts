...
/**
 * VitalSigns class: http://vital.ai/ontology/vital-aimp#AnswerUnsetMessage
 */
export class AnswerUnsetMessage extends AIMPMessage {
  ...
  /**
   * Get property definitions for AnswerUnsetMessage
   */
