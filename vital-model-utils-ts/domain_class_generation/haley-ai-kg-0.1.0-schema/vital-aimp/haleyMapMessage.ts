...
/**
 * VitalSigns class: http://vital.ai/ontology/vital-aimp#HaleyMapMessage
 */
export class HaleyMapMessage extends HaleyMessage {
  ...
  /**
   * Get property definitions for HaleyMapMessage
   */
