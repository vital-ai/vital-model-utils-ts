...
/**
 * VitalSigns class: http://vital.ai/ontology/vital-aimp#DialogDatascriptAction
 */
export class DialogDatascriptAction extends DialogAction {
  ...
  /**
   * Get property definitions for DialogDatascriptAction
   */
