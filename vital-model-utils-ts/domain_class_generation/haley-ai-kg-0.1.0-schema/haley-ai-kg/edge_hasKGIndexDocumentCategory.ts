...
/**
 * VitalSigns class: http://vital.ai/ontology/haley-ai-kg#Edge_hasKGIndexDocumentCategory
 */
export class Edge_hasKGIndexDocumentCategory extends VITAL_PeerEdge {
  ...
  /**
   * Get property definitions for Edge_hasKGIndexDocumentCategory
   */
  ...
  /**
   * Get the VitalSigns type URI for Edge_hasKGIndexDocumentCategory
   */
