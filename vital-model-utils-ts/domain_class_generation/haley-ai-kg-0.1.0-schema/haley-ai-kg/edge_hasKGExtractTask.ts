...
/**
 * VitalSigns class: http://vital.ai/ontology/haley-ai-kg#Edge_hasKGExtractTask
 */
export class Edge_hasKGExtractTask extends VITAL_PeerEdge {
  ...
  /**
   * Get property definitions for Edge_hasKGExtractTask
   */
  ...
  /**
   * Get the VitalSigns type URI for Edge_hasKGExtractTask
   */
