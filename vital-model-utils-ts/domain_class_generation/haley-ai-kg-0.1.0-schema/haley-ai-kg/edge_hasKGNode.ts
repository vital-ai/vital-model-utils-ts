...
/**
 * VitalSigns class: http://vital.ai/ontology/haley-ai-kg#Edge_hasKGNode
 */
export class Edge_hasKGNode extends VITAL_PeerEdge {
  ...
  /**
   * Get property definitions for Edge_hasKGNode
   */
  ...
  /**
   * Get the VitalSigns type URI for Edge_hasKGNode
   */
