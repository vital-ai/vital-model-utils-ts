...
/**
 * VitalSigns class: http://vital.ai/ontology/haley#HaleyMindRequest
 */
export class HaleyMindRequest extends VITAL_Node {
  public readonly haleyMindAgentInstanceURI?: string;
  ...
  public readonly commandProcessorNotificationChannelURI?: string;
  ...
  /**
   * Get property definitions for HaleyMindRequest
   */
  getPropertyDefinitions(): VitalSignsPropertyDefinition[] {
    return [
      ...super.getPropertyDefinitions(),
      {
        propertyURI: 'http://vital.ai/ontology/haley#hasHaleyMindAgentInstanceURI',
        tsPropertyName: 'haleyMindAgentInstanceURI',
        type: 'string',
        required: false,
        format: 'uri'
      },
      ...
      {
        propertyURI: 'http://vital.ai/ontology/haley#hasCommandProcessorNotificationChannelURI',
        tsPropertyName: 'commandProcessorNotificationChannelURI',
        type: 'string',
        required: false,
        format: 'uri'
      },
