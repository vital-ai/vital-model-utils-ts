...
/**
 * VitalSigns class: http://vital.ai/ontology/haley#Edge_hasHaleyAccessLoginRole
 */
export class Edge_hasHaleyAccessLoginRole extends VITAL_PeerEdge {
  ...
  /**
   * Get property definitions for Edge_hasHaleyAccessLoginRole
   */
  ...
  /**
   * Get the VitalSigns type URI for Edge_hasHaleyAccessLoginRole
   */
