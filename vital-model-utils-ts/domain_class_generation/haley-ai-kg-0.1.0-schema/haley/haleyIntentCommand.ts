...
/**
 * VitalSigns class: http://vital.ai/ontology/haley#HaleyIntentCommand
 */
export class HaleyIntentCommand extends UserCommandMessage {
  ...
  /**
   * Get property definitions for HaleyIntentCommand
   */
